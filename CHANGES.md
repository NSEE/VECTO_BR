...
- Features
    ...
    * CodeEU n.a.: multiple powertrains completed and single bus. (vecto/vecto!516)
    * CodeEU n.a.: Single-gear IEPC in multiple powertrains (vecto/vecto!524)

- Bug Fixes

    * CodeEU #1208: Vecto console references (vecto/vecto!507)
    * CodeEU #1204: Completed bus input generation for v2.7 (vecto/vecto!508)
    * CodeEU #657, #702: DefaultDriverStrategy - add accel action after gearshift + roll + brake if overload (vecto/vecto!510)
    * CodeEU #814, #990, #1057: Add retarder losses to TC max torque request (vecto/vecto!511)
    * CodeEU #1211: Rename constructor parameter to match factory method (vecto/vecto!512)
    * CodeEU #1218: Propagate 'allowDeprecated' parameter for XMLReader classes through injection hierarchy (vecto/vecto!513)
    * CodeEU n.a.: Multiple powertrain FCHV bus execution (vecto/vecto!515)
    * CodeEU n.a.: vsum fields for Retarder, Axlegear for multiple powertrains. (vecto/vecto!517)
    * CodeEU #1179: Increase max iteration in InterpolateSearch (vecto/vecto!514)
    * CodeEU #1225: use of battery SoC limits (input vs default) (vecto/vecto!519)
    * CodeEU #1146: Create fuel cell in testpowertrain (required in shift strategy) (vecto/vecto!520)
    * CodeEU n.a.: Added missing function to DummyRunNinjectModule (vecto/vecto!521)
    * CodeEU #1079: Calculation of axlegear efficiency for P4 vehicles: in case of an P4, use EM-in to calculate axlegear efficiency instead of Brake-in (vecto/vecto!522)
    * CodeEU n.a.: Added multiple-powertrain sample jobs (vecto/vecto!525)
    * CodeEU n.a.: Avoid null reference in DeclarationData.cs (vecto/vecto!526)
    * CodeEU n.a.: bugs regarding multiple powertrains. (vecto/vecto!527)
    * CodeEU n.a.: Modified Torque Converter columns to handle multiple powertrains. (vecto/vecto!528)
    * CodeEU n.a.: OVC-HEV mode for FCHV vehicles, null reference in fuel cells. (vecto/vecto!529)
    * CodeEU n.a.: Don't allow unsupported variations of multiple powertrain vehicles. (vecto/vecto!530)
    * CodeEU n.a.: Enable unsupported vehicles in development mode (vecto/vecto!531)

- Refact

    * CodeEU n.a.: Refactored multiple powertrains builder methods (vecto/vecto!509)
    * CodeEU n.a.: Reduced build-time warnings (vecto/vecto!518)
    * CodeEU n.a.: Project vecto sw3/task 2/unit tests amdm3 (vecto/vecto!460)
...
- Bug Fixes
    ...
    * CodeEU n.a.: Display version dynamically (vecto/vecto!490)
    * CodeEU n.a.: Gen veh FCHV values and DI (vecto/vecto!506)

- Refact

    * CodeEU n.a.: Remove redundant code (vecto/vecto!493)**Release/v5.0.6-RC (22-09-2025)**
...
- Bug Fixes
    ...
    * CodeEU n.a.: Addressed vulnerability issues (vecto/vecto!328)
...
- Refact
    ...
    * CodeEU n.a.: Remove unnecessary usings and nugets (vecto/vecto!473)**XMLConverterTool/5.0.4 (04-09-2025)**
...
- Features
    ...
    * CodeEU n.a.: XMLConversionTool can convert to version v2.7 (+ bugfixes) (vecto/vecto!451)
...
- Bug Fixes
    ...
    * CodeEU n.a.: FCHV unit tests (vecto/vecto!448)
    * CodeEU n.a.: XMLConversionTool bug fixes, more test cases, refactoring. (vecto/vecto!452)
    * CodeEU n.a.: Bug for FCHV bus. (vecto/vecto!454)
    * CodeEU n.a.: Conversion Tool ovcHev bug, affected Generic Vehicles (vecto/vecto!455)
...
- Refact
    ...
    * CodeEU n.a.: Fchv iterative run strategy (vecto/vecto!449)**Nuget/v0.11.4-DEV (08-04-2025)**


- Features

    * CodeEU n.a.: Partial implementation for new vehicle battery (vecto/vecto!337)**Release/v0.15.0-DEV (08-04-2025)**
...
- Bug Fixes
    ...
    * CodeEU n.a.: Updated Monitoring Report XSD (FCHV, Multiple powertrains) (vecto/vecto!335)**Release/v0.11.4-DEV (02-04-2025)**


- Features

    * CodeEU #855: IEPC with multiple load curves (#855) (vecto/vecto!321)
    * CodeEU n.a.: H2 ICE vehicle in declaration mode (vecto/vecto!325)

- Bug Fixes

    * CodeEU n.a.: Added error message for unknown completed vehicle missions (vecto/vecto!330)
    * CodeEU n.a.: Segment lookup method (vecto/vecto!331)
    * CodeEU n.a.: FullLoadCurves proper initialization (vecto/vecto!332)
    * CodeEU n.a.: Manage 'GetTruckSegment' exception behavior (vecto/vecto!333)**Release/4.3.3 (04-03-2025)**
...
- Documentation
    ...
    * CodeEU n.a.: Update XSD parameter IDs documentation (vecto/vecto!327)**Release/4.3.2-RC (06-02-2025)**
...
- Bug Fixes
    ...
    * CodeEU #890: Add condition to write BusAuxiliaries output data in vsum (vecto/vecto!306)**Release/v4.3.0-DEV (03-02-2025)**
...
- Bug Fixes
    ...
    * CodeEU #858: Convert steering pump tech (vecto/vecto!303)**Release/4.2.6-RC (06-12-2024)**
...
- Bug Fixes
    ...
    * CodeEU #495, #642, #739: Add SMT downshift condition - DroppedSpd>DisengSpd (vecto/vecto!293)**Release/v4.2.5 (02-10-2024)**


- Bug Fixes

    * Missing Build.props DefineConstants (vecto/vecto!268)
    * Version 4th number read from Build.props (vecto/vecto!269)**Release/v4.2.3 (01-10-2024)**
...
- Bug Fixes
    ...
    * Update changelog script**Release/v4.2.2.3539-RC (09-09-2024)**
