...
namespace TUGraz.Vecto.UnitTests.TestCases.Components.GearShiftStrategy
{
	...
	public class APTNShiftStrategyTests
	{
		...
		[TestCase(
			...
			10000,
			1,
			2, TestName = "APTNShiftStrategy Emergency UpShift")]
		...
		[TestCase(
			...
			800,
			1,
			1, TestName = "APTNShiftStrategy No Upshift")]
		...
		[TestCase(
			...
			200,
			2,
			1, TestName = "APTNShiftStrategy Downshift")]
		...
		[TestCase(
			...
			40,
			4,
			2, TestName = "APTNShiftStrategy Downshift_SkipGear")]
		...
		private Mock<IElectricSystem> GetMockElectricSystem()
		{
			...
			electricSystem
				...
				.Returns((Second t, Second dt, Watt powerDemand, bool dryrun) => {
					...
					reessResponse.SetupGet(r => r.MaxChargePower).Returns(0.SI<Watt>());
