...
public class CombustionEngineDataProvider_v20_Tests
{
    ...
    private const string CombustionEngine_v20 = @"<?xml version=""1.0"" encoding=""UTF-8""?>
<tns:VectoInputDeclaration xmlns=""urn:tugraz:ivt:VectoAPI:DeclarationDefinitions:v2.0""
													...
													xsi:schemaLocation=""urn:tugraz:ivt:VectoAPI:DeclarationComponent:v2.0 v:\VectoCore/Vectocore/Resources/XSD/VectoComponent.2.0.xsd"">
	<tns:Engine>
