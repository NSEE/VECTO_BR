...
namespace TUGraz.VectoCore.Ninject.XMLReports
{
    internal class CIFNinjectModule : MRFNinjectModule
    {
		...
		public override void Load()
		{
			...
			#region Lorry CIF
			Bind<IXMLCustomerReport>().To<ConventionalLorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
			...
			Bind<IXMLCustomerReport>().To<HEV_PxLorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry, 
			...
			Bind<IXMLCustomerReport>().To<HEV_S2_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry, 
			...
			Bind<IXMLCustomerReport>().To<HEV_S3_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry, 
					VectoSimulationJobType.SerialHybridVehicle,
					ArchitectureID.S3, 
			...
			Bind<IXMLCustomerReport>().To<HEV_S4_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry, 
					VectoSimulationJobType.SerialHybridVehicle,
					ArchitectureID.S4, 
			...
			Bind<IXMLCustomerReport>().To<HEV_IEPC_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry, 
            ...
            Bind<IXMLCustomerReport>().To<Multiple_FCHV_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.Lorry,
            ...
            Bind<IXMLCustomerReport>().To<Multiple_PEV_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.Lorry,
            ...
            Bind<IXMLCustomerReport>().To<Multiple_SHEV_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.Lorry,
            ...
            Bind<IXMLCustomerReport>().To<FCHV_F2_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry,
			...
			Bind<IXMLCustomerReport>().To<FCHV_F3_Lorry_CIF>()
				.Named(VehicleTypeAndArchitectureStringHelper.CreateName(VehicleTypeAndArchitectureStringHelper
				.ToParams(
					VehicleCategoryHelper.Lorry,
					VectoSimulationJobType.FCHV,
					ArchitectureID.F3,
			...
			Bind<IXMLCustomerReport>().To<PEV_E2_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry,
			...
			Bind<IXMLCustomerReport>().To<PEV_E3_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry,
					VectoSimulationJobType.BatteryElectricVehicle,
					ArchitectureID.E3,
			...
			Bind<IXMLCustomerReport>().To<PEV_E4_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry,
					VectoSimulationJobType.BatteryElectricVehicle,
					ArchitectureID.E4,
			...
			Bind<IXMLCustomerReport>().To<PEV_IEPC_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.Lorry,
			...
			Bind<IXMLCustomerReport>().To<Exempted_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(VehicleCategoryHelper.Lorry,
					VectoSimulationJobType.ConventionalVehicle,
					ArchitectureID.UNKNOWN,
					true,
					false,
			...
			Bind<IXMLCustomerReport>().To<Exempted_Lorry_CIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(VehicleCategoryHelper.Van,
					VectoSimulationJobType.ConventionalVehicle,
					ArchitectureID.UNKNOWN,
                    true,
					false,
			...
			Bind<IXMLCustomerReport>().To<Conventional_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
			...
			Bind<IXMLCustomerReport>().To<HEV_Px_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.ParallelHybridVehicle,
					ArchitectureID.UNKNOWN,
			...
			Bind<IXMLCustomerReport>().To<HEV_IHPC_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.IHPC,
					ArchitectureID.P2,
            ...
            Bind<IXMLCustomerReport>().To<HEV_S2_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.SerialHybridVehicle,
					ArchitectureID.S2,
			...
			Bind<IXMLCustomerReport>().To<HEV_S3_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.SerialHybridVehicle,
					ArchitectureID.S3,
			...
			Bind<IXMLCustomerReport>().To<HEV_S4_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.SerialHybridVehicle,
					ArchitectureID.S4,
			...
			Bind<IXMLCustomerReport>().To<HEV_IEPC_S_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.IEPC_S,
					ArchitectureID.S_IEPC,
			...
			Bind<IXMLCustomerReport>().To<PEV_E2_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.BatteryElectricVehicle,
					ArchitectureID.E2,
			...
			Bind<IXMLCustomerReport>().To<PEV_E3_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.BatteryElectricVehicle,
					ArchitectureID.E3,
			...
			Bind<IXMLCustomerReport>().To<PEV_E4_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.BatteryElectricVehicle,
					ArchitectureID.E4,
			...
			Bind<IXMLCustomerReport>().To<PEV_IEPC_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.IEPC_E,
					ArchitectureID.E_IEPC,
            ...
            Bind<IXMLCustomerReport>().To<FCHV_F2_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.CompletedBus,
                    VectoSimulationJobType.FCHV,
                    ArchitectureID.F2,
            ...
            Bind<IXMLCustomerReport>().To<FCHV_F3_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.CompletedBus,
                    VectoSimulationJobType.FCHV,
                    ArchitectureID.F3,
            ...
            Bind<IXMLCustomerReport>().To<FCHV_F4_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.CompletedBus,
                    VectoSimulationJobType.FCHV,
                    ArchitectureID.F4,
            ...
            Bind<IXMLCustomerReport>().To<FCHV_IEPC_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.CompletedBus,
                    VectoSimulationJobType.FCHV_IEPC,
                    ArchitectureID.F_IEPC,
            ...
            Bind<IXMLCustomerReport>().To<Multiple_FCHV_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.CompletedBus,
                    VectoSimulationJobType.Multiple_FCHV,
                    ArchitectureID.F2,
            ...
            Bind<IXMLCustomerReport>().To<Multiple_PEV_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.CompletedBus,
                    VectoSimulationJobType.Multiple_PEV,
                    ArchitectureID.E2,
            ...
            Bind<IXMLCustomerReport>().To<Multiple_SHEV_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
                VehicleTypeAndArchitectureStringHelper.ToParams(
                    VehicleCategoryHelper.CompletedBus,
                    VectoSimulationJobType.Multiple_SHEV,
                    ArchitectureID.S2,
            ...
            Bind<IXMLCustomerReport>().To<Exempted_CompletedBusCIF>().Named(VehicleTypeAndArchitectureStringHelper.CreateName.Invoke(
				VehicleTypeAndArchitectureStringHelper.ToParams(
					VehicleCategoryHelper.CompletedBus,
					VectoSimulationJobType.ConventionalVehicle,
					ArchitectureID.UNKNOWN,
